...
<body>
	...
	<?php
		...
		$cod_semillero=$_SESSION['codSemillero'];

		ECHO $consulta="SELECT * FROM `semillero` WHERE cod_semillero='$cod_semillero';";
					...
					<form id="formulario_ingreso_semillero" method="POST" action="confirmar_semillero.php" enctype="multipart/form-data">
						...
						<div id="datos_principales">
							...
							<p id="ingreso_semillero">
								...
								<input class="ingreso_texto" type="text" name="nombre" value="<?php echo $fila['1'];?>">
							</p>
